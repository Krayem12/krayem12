...
class ConfigManager:
    ...
    def setup_config(self) -> None:
        ...
        try:
            ...
            self.config = {
                ...
                'TREND_CHANGE_THRESHOLD': self._safe_int_convert('TREND_CHANGE_THRESHOLD', 2),
            ...
            logger.info("✅ تم تحميل إعدادات النظام بنجاح")
    ...
    def _load_all_signals(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            'group3_bullish': self._load_signal_list('ENTRY_SIGNALS_GROUP3_BULLISH', 'bullish_moneyflow_co_50'),
            'group3_bearish': self._load_signal_list('ENTRY_SIGNALS_GROUP3_BEARISH', 'bearish_moneyflow_cu_50'),
